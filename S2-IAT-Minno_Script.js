	...
	**/
	...
	function iatExtension(options)
	{
		...
		var iatObj =
		{
			...
			category1 : {
				name : 'Robots', //Will appear in the data and in the default feedback message.
				title : {
					media : {word : 'Robots'}, //Name of the category presented in the task.
			...
			category2 :	{
				name : 'Toys', //Will appear in the data and in the default feedback message.
				title : {
			...
			base_url : {//Where are your images at?
				image : '/Users/46079386/Documents/GitHub/qualtrics-IAT/images/'
			},
